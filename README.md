...
Both the swing probability and hit probability models were created in a Jupyter notebook ([swing-probabilities-cm.ipynb](notebooks/swing-probabilities-cm.ipynb))

Preliminary research was done in [LogisticRegression.ipynb](notebooks/LogisticRegression.ipynb)
